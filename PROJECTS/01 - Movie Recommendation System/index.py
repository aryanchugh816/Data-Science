...
def main():
    ...
    st.subheader(" ")
    st.markdown("[Click here](https://github.com/aryanchugh816/Data-Science/blob/master/PROJECTS/01%20-%20Movie%20Recommendation%20System/index.py) to see the code and feel free to browse my [Github repository](https://github.com/aryanchugh816/Data-Science) for more projects and articles related to machine learning")
    st.subheader(" ")
